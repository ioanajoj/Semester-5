...
class WaiterOrdersAdapter : RecyclerView.Adapter<WaiterOrdersAdapter.ViewHolder>() {
...
//            TODO("Decide what to do on item click")
            ...
            intent.putExtra("table", entity.table)
            intent.putExtra("details", entity.details)
            intent.putExtra("status", entity.status)
            intent.putExtra("time", entity.time)
