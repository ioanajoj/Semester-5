...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[][] m1 = createMatrix(70, 100);
        int[][] m2 = createMatrix(100, 70);

        Matrix matrix1 = new Matrix(70, 100, m1, NO_OF_THREADS);
        Matrix matrix2 = new Matrix(100, 70, m2, NO_OF_THREADS);
